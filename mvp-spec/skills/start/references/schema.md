...
Documents are written in interview order, one at a time, and the founder reviews each file before the next is started. The first missing file in 01 to 12 is where a new session resumes. Files 13 and 14 are appended to throughout. 00 is written last, at packaging.
