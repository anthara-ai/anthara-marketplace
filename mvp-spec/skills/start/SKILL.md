...
Before the first question, learn the founder's domain in one pass: what the people in it are trying to do, the words they use, what comparable products offer, which rules tend to apply. Use it to ask sharper questions and to offer menu options a founder recognises rather than generic ones; a wrong option in a menu is worse than none, because a founder who does not know better may accept it. Research shapes questions and options only. Nothing researched goes into a document as a statement, it never becomes advice, and where it disagrees with the founder about their own product, the founder is right. Look an unfamiliar term up rather than asking the founder to teach you their field. If search is unavailable, say so once and carry on.

## Asking

- One question at a time. A founder who needs to think gets one thing to think about.
- AskUserQuestion by default. Its options are suggestions, not a closed list: the founder can always type their own answer, so a menu shows someone who has not thought about a thing what a reasonable answer looks like, and costs nothing for someone who has. Two to four concrete options; where "I have not decided" or "I would rather not say" is a real answer, offer it and send it to 13. Up to four quick, related questions can share one call; four hard ones cannot.
- Prose only where the founder's own wording is the deliverable: the product paragraph, a journey narrative, done-means statements, sample copy in the app's voice. Each document skill names its exceptions.
