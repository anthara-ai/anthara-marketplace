...
- This holds for the whole interview, not just its opening. Before every question, decide which shape it is; the pull toward writing prose grows as a conversation goes on, and a menu-shaped question asked as prose is a worse question. If a question offers the founder three or four alternatives, it is a menu, whatever it would sound like written out.
...
- Each document skill opens with an Asking section naming which of its questions are menu-shaped and which need prose. Read it before asking that document's first question, and follow it.
