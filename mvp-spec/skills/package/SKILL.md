...
- Every link in the 11.NN files, the hub included, resolves to a file that exists, and each persona's journey can be clicked through from the hub without a dead end.
