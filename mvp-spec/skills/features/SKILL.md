---
name: features
description: This skill should be used when the mvp-spec interview reaches "06 - Features and Acceptance Criteria.md", or when the founder wants to define "features", "acceptance criteria", "what done means", "edge cases", "what happens if", "account deletion", or "where the paywall goes". Makes every Must item estimable with plain done-means statements and unhappy-path handling.
---

# 06 Features and Acceptance Criteria

Phase 06 of the `mvp-spec` interview. The interview rules and package contract live in the `mvp-spec` skill; if this phase was entered directly rather than from that skill, read `${CLAUDE_PLUGIN_ROOT}/skills/mvp-spec/SKILL.md` first.
